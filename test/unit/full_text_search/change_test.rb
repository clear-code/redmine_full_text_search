    ...
    def test_fetch_changesets
      ...
      assert_equal([
                     ...
                     ],
                     {
                       ...
                       "original_created_on" => Time.parse("2017-09-10T16:54:52Z"),
                       "original_updated_on" => Time.parse("2017-09-10T16:54:52Z"),
                       "name" => null_string,
                     ...
                     },
                     {
                       ...
                       "original_id" => 20,
                       "original_type" => "Change",
                       "original_created_on" => Time.parse("2010-01-20T09:13:43Z"),
                       "original_updated_on" => Time.parse("2010-01-20T09:13:43Z"),
                       "name" => null_string,
                       "description" => null_string,
                       "identifier" => "11",
                       "status" => null_number,
